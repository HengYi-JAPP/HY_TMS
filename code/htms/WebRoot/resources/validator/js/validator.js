...
var __validate_rules=[      
	  ...
	  },
	  {
		  ...
		  {
			 type:"isidcard",
			 tester:/^(^[1-9][0-9]{5}[0-9]{2}((01|03|05|07|08|10|12)(0[1-9]|[1-2][0-9]|31)|(04|06|09|11)(0[1-9]|[1-2][0-9]|30)|02(0[1-9]|[1-2][0-9]))[0-9]{2}([0-9]|x|X)$)|(^[1-9][0-9]{5}(19|20)[0-9]{2}((01|03|05|07|08|10|12)(0[1-9]|[1-2][0-9]|31)|(04|06|09|11)(0[1-9]|[1-2][0-9]|30)|02(0[1-9]|[1-2][0-9]))[0-9]{3}([0-9]|x|X)$)$/, 
			 normal:"请输入身份证号",
			 error:"请输入正确的身份证号",
			 correct:"输入正确"
		 },
		 {
			 type:"vehicleno",
			 tester:/(^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领A-Z]{1}[A-Z]{1}[A-Z0-9]{4}[A-Z0-9挂学警港澳]{1}$)/, 
			 normal:"请输入车牌号",
			 error:"请输入正确的车牌号",
			 correct:"输入正确"
		 },
...
function __init(formId,elementId,params){
	  var attr = params.split('|');
	  for (j=0,size1=attr.length; j < size1 ; j++){
		  var value = attr[j].split('=');
		  if(value[1] == "null" || value[1] == null || value[1] == undefined){
		  }else{
			  document.getElementById(elementId).setAttribute(value[0], value[1]); 
		  }
	  }
}
