	...
	<body>
			...
			<div class="webWin">
				...
				<div class="wContent">
					...
					<div style="width: 300px; height: 200px; padding: 2px;">
						此处显示新 Div 标签的内容此处显示新 Div 标签的内容
						<br>
						此处显示新 Div 标签的内容此处显示新 Div 标签的内容
						<br>
						此处显示新 Div 标签的内容
		...
		<div class="webWinFrame" id="testWinB" style="top: 110px;">
			<div class="webWin">
				...
				<div class="wContent">
					<!---->
					此处显示新 Div 标签的内容 此处显示新 Div 标签的内容 此处显示新 Div 标签的内容 资源来自：烈火学院
					veryhuo.com
					<!---->
				</div>
				<div class="wResizeBox"></div>
...
// 烈火網 VeryHuo.Com 欢迎复制,拒绝恶意采集 ｌｉｅｈｕｏ．ｎｅｔ
...
<center>
	...
	<a href='http://www.huanju.org/' target='_blank'>http://www.huanju.org/</a>
</center>