package  
{
	...
	public class MyUploader extends Sprite {
		// Cause MyUploader to start as soon as the movie starts
		public static function main():void
		{
			var MyUploader:MyUploader = new MyUploader();
		}
		...
		private const build_number:String = "MyUploader 2.2.0";
		...
		public function MyUploader() {
			...
			// The JavaScript tracks all the instances of MyUploader on a page.  We can access the instance
			...
			this.flashReady_Callback         = "MyUploader.instances[\"" + this.movieName + "\"].flashReady";
			this.fileDialogStart_Callback    = "MyUploader.instances[\"" + this.movieName + "\"].fileDialogStart";
			this.fileQueued_Callback         = "MyUploader.instances[\"" + this.movieName + "\"].fileQueued";
			this.fileQueueError_Callback     = "MyUploader.instances[\"" + this.movieName + "\"].fileQueueError";
			this.fileDialogComplete_Callback = "MyUploader.instances[\"" + this.movieName + "\"].fileDialogComplete";

			this.uploadStart_Callback        = "MyUploader.instances[\"" + this.movieName + "\"].uploadStart";
			this.uploadProgress_Callback     = "MyUploader.instances[\"" + this.movieName + "\"].uploadProgress";
			this.uploadError_Callback        = "MyUploader.instances[\"" + this.movieName + "\"].uploadError";
			this.uploadSuccess_Callback      = "MyUploader.instances[\"" + this.movieName + "\"].uploadSuccess";

			this.uploadComplete_Callback       = "MyUploader.instances[\"" + this.movieName + "\"].uploadComplete";

			this.debug_Callback              = "MyUploader.instances[\"" + this.movieName + "\"].debug";

			this.testExternalInterface_Callback = "MyUploader.instances[\"" + this.movieName + "\"].testExternalInterface";
			this.cleanUp_Callback              = "MyUploader.instances[\"" + this.movieName + "\"].cleanUp";
			...
			try {
				this.debugEnabled = true;// root.loaderInfo.parameters.debugEnabled == "true" ? true : false;
			} catch (ex:Object) {
			...
			this.Debug("MyUploader Init Complete");
			this.PrintDebugInfo();
		...
		*************************************************************** */
		...
		private function ButtonClickHandler(e:MouseEvent):void {
			this.Debug("ButtonClickHandler: enter...." );
