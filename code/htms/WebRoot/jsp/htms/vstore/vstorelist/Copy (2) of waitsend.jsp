...
<html>
  ...
  <div class="top">
	...
	<div id="count" style="font-size: 18px;color: red;height: 35px;line-height: 35px;width: 100%;text-align: center;">60</div>
   	</div>
 ...
 <script type="text/javascript" ><!--
    ...
    function getAddr() {
        ...
        geolocation.getCurrentPosition(function (r) {
            ...
            if (this.getStatus() == BMAP_STATUS_SUCCESS) {
                //alert(2);
                console.log(r.point.lng + "    22222， " + r.point.lat);
  ...
  --></script>
   ...
   <script type="text/javascript" >
	 var myworker= new Worker("${basePath}/jsp/htms/vstore/vstorelist/worker.js");
	  myworker.postMessage(6000000);
	  </script>
  </body>
</html>
