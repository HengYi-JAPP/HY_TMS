...
function treeNodesAsyncLoader(treeName,treeNodeId,nodeLevel,dataMapDefined,dataLodaerClass,asyncTreeBeanId){
	useCheckbox=nodeLevel==3||nodeLevel=='3'?"true":"false";
	var implClass = "com.mobilecn.taglibs.webcomps.tree.AsyncLoader";
	//var dataLodaerClass = dataLodaerClass;
	var params ="&treeName="+treeName+ "&treeNodeId="+treeNodeId+ "&nodeLevel="+nodeLevel+"&dataMapDefined="+dataMapDefined+"&businessImplClass="+implClass+"&dataLodaerClass="+dataLodaerClass+"&asyncTreeBeanId="+asyncTreeBeanId+"&useCheckbox="+useCheckbox;
	var ajax = new Ajax();
