...
<html:page title="选择地址">
	...
	<com:loader js="resources/simpleupload/jquery-min.js,jsp/htms/dictionary/route/async-loader.js" />
				<!-- banner 页面导航条 -->
	...
	<com:tree  treeList="areaTreeList" treeName="myTree" useCheckBox="false" chooseStyle="single" cacheElementName="checkAreaId" treeNodeId="areaId" appendNodeOperation="false" useNodeImage="false" expandAll="0" useLink="false" isAsync="true" specify="true"  asyncDataLodaerClass="com.zzy.htms.dictionary.area.AsyncAreaLoader">
