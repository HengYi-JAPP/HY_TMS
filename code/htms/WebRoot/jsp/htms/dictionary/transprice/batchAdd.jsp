...
<com:loader  js="js/common/common.js,jsp/htms/dictionary/transprice/transprice.js,js/console/list/list.js"/>
...
<html:form id="transPriceForm"  enctype="application/x-www-form-urlencoded"  action="contoller.do"  method="POST" >
	...
	<html:hidden id="operation" name="operation" value="toBatchAddTransPrice"/>	
	...
	<html:table id="1647" styleClass="edit-talbe" list="routeViewBean" bean="routeViewBean">
		...
		<tr class="trCell">
			...
			<html:td   style="text-align:left;vertical-align:middle;font-size:12px">
				<font id="productTip" style="font-size:12px;">请选择产品和厂区。</font>
			</html:td>
		</tr>--%>
		<html:tr styleClass="trCell">
			<html:td styleClass="edit-talbe-label" >
	...
	<html:table  cellSpacing="0"  align="center" isHead="false" >
		<html:tr >
			...
			<html:td style="text-align:center;">
				&nbsp;&nbsp;
				<btn:save href="javascript:void(0);" onclick="validateBatchTransPrice(true,'addBatchTransPrice');"/>
