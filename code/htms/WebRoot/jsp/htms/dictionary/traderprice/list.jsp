...
<%@page import="com.zzy.htms.dictionary.traderprice.TraderPriceBean"%>
<%@page import="java.util.*"%>
<%@ include file="../../../common/impart/taglib.jsp"%>
<%@ include file="../../../common/impart/common.jsp"%>
<%@ page import="com.zzy.htms.dictionary.traderprice.TraderPriceRepository,com.zzy.htms.sales.customerprice.CustomerPriceUtils" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Traderitional//EN">
<%String path = request.getContextPath();String basePath = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + path + "/"; 
Map<Object,Map<Object,Map<Object, List>>> onePricesMap=(Map<Object,Map<Object,Map<Object, List>>>)request.getAttribute("traderpriceMap");
...
<html:form id="traderPriceForm"  enctype="application/x-www-form-urlencoded" loadCache="true" action="contoller.do"  method="GET" >
	<com:loader  simplendar="true"  />   
	<html:hidden id="operation" name="operation" value="listTraderPrice"/>
	<com:loader binder="true" checkall="true" switchbox="true" ajax="true" />
	<jsp:include page="../../../common/impart/table-banner-new.jsp">
		<jsp:param value='贸易商运价管理' name="title"/>
	</jsp:include> 
	...
	<table>
		<tr class="trCell">
			<td   class=""   id="manageBox" colspan="10" >
				<btn:new href="contoller.do?operation=toBatchAddTraderPrice"/>
				<%--<btn:button name="批量调整运价" href="contoller.do?operation=toBatchAddTraderPrice" typeId="batchAddRoute" value="批量调整运价" styleClass="button-self-style"/>--%>
				<btn:delete href="javascript:batch_deletes('traderPriceForm','traderPriceId','','deleteTraderPrice');" />
				<btn:rollback href="contoller.do?operation=syncLocalHostCahce&syncType=TRADE_PRICE" value="加载"/>
			</td>
		</tr>
	</table>
...
<%
	TraderPriceBean traderBean = null,nestBean=null;
	List tempList=null;
			...
			while(threeIt.hasNext()){
				...
				tempList=threeMap.get(threeId);
					...
					for(int i=0,size=tempList.size();i<size;i++){	
						nestBean=(TraderPriceBean)tempList.get(i);
						request.setAttribute("traderPriceBean",nestBean);
					%>
						...
						<%} %>
						<td><html:checkbox name="traderPriceId" id="traderPriceId" value="<%=nestBean.getPriceId() %>" /></td>
						<td>
							<html:a href="contoller.do?operation=viewTraderPrice&isModify=0&traderPriceId=$[traderPriceBean.priceId]&checkRouteId=$[traderPriceBean.routeId]&areaId=$[traderPriceBean.areaId]">
						...
						<td>
						 ...
						 --%>
						<td width="136px">
						<btn:modify href="contoller.do?operation=viewTraderPrice&isModify=1&traderPriceId=$[traderPriceBean.priceId]&checkRouteId=$[traderPriceBean.routeId]&areaId=$[traderPriceBean.areaId]"/>
						<btn:delete href="javascript:deleteRow('contoller.do?operation=deleteTraderPrice&traderPriceId=$[traderPriceBean.priceId]')"/>
						</td>
	...
	<table id="pageFooter" class="">
		<tr class="trCell">
			<td   class="pagination"   id="pagination" colSpan="1" rowSpan="1">
				...
				<com:page formId="traderPriceForm" pageCtlName="pageCtl"/>
			</td>
		</tr>
	</table>
</html:form>
