...
<com:loader css="css/common/sub-table-list.css"/>
	...
	<jsp:include page="../../../common/impart/table-banner-new.jsp">
		<jsp:param value='查看贸易商运价' name="title"/>
	</jsp:include>
	...
	<html:table id="1647" styleClass="edit-talbe" list="routeViewBean" bean="routeViewBean">
		...
		<html:tr styleClass="trCell">
			...
			<html:td >
				<html:value  value="$[traderPriceViewBean.priceStart]"/>
			</html:td>
			<html:td styleClass="edit-talbe-label" >
				结束区间
			</html:td>
			<html:td width="180px">
				<html:value  value="$[traderPriceViewBean.priceEnd]"/>
			</html:td>
		</html:tr>
		<html:tr styleClass="trCell">
			<html:td    styleClass="edit-talbe-label" style="width:18%;">
				计费模式
			</html:td> 
			...
			<html:td width="180px">
				<html:value value="$[traderPriceViewBean.validateDate]" />
			</html:td>
		</html:tr>
	...
	<div id="singlePrice" style="display:block;">
		...
		<tr>
			<td class="edit-talbe-label" style="width:18%;">
				运价
			</td>
			<td width="180px">
				<html:value value="$[traderPriceViewBean.customerPrice]"/>
			</td>
			<!--  <td class="edit-talbe-label" >
				承运商运价
			</td>
			<td width="180px">
				<html:value value="$[traderPriceViewBean.carrierPrice]"/>
			</td>
			-->
		</tr>
		</table>
	...
	<div id="allPrice" style="display:none;">
		...
		<tr >	
			...
			<td  width="180px">
				<html:value  value="$[traderPriceViewBean.customerOnePrice]"/>
			</td>
			<!-- 
			<td class="edit-talbe-label">
				承运商运价
			...
			<td  width="180px">
				<html:value value="$[traderPriceViewBean.carrierOnePrice]"/>
			</td>
			-->
		</tr>
	</table>
