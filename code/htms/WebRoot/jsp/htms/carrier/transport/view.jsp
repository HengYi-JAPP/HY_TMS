...
<com:loader css="css/common/sub-table-list.css"  myWin="true"/>
	...
	<jsp:include page="../../../common/impart/table-banner-new.jsp">
		<jsp:param value='<%=tools.tool.getLocal("jsp.htms.logistic.transport.title.view") %>' name="title"/>
	</jsp:include>
	</div>
								...
								%>
									<tr>
										...
										<td style="text-align:center;height:35px;">
											<%=detailBean.getCodetailCertificateDesc() %>
										</td>
										<%--
										...
										<% }%>	
										<%--
										 <td style="text-align:right;" rowspan="<%=i==0?isize:1 %>"><%=transportBean.getApplyTonNum()%></td>
										<td style="text-align:right;"  rowspan="<%=i==0?isize:1 %>"><%=transportBean.getApplyPackNum() %></td> --%>
									</tr>
								<%
