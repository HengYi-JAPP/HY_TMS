...
function toAssign(){
	var tonNum=document.getElementById("transportTonNum").value;
	 ...
	 //	return;
	 //}
	 batchDelete('transportForm','checkTransportId','','toAssignTransportToLogistics');
}
...
<html:form id="transportForm"  enctype="application/x-www-form-urlencoded"  action="contoller.do"  method="GET" loadCache="true" >
	...
	<html:hidden id="operation" name="operation" value="listTransportToLogistics"/>
	...
	<table style="width: 100%;border-spacing: 0;padding:3px 0;">
		<tr class="trCell">
			...
			<td colspan="6"  rowSpan="1" width="200px;">
			<div style="float:left;display:inline;">
				<div style="float:left;">
			...
			<td colspan="1"  rowSpan="1">
				<btn:displayfields href="javascript:void(0);" onclick="ShowOrHideMenu('leftShowArea');" value="更多属性"/>
			</td>
		</tr>
</table>
<div style="width:100%;text-align:left; float:left;overflow-x:scroll;overflow-y:hidden;" >
			...
			<tr  align="left" style="border:0px;margin:0px;padding:0px;">
				<td  align="left" style="border:0px;margin:0px;padding:0px;">
						...
						<tr  class="dgHeaderStyle" >
							...
							<!-- <td style="text-align:center;white-space: nowrap;min-width:50px">合并状态</td>
	    	                <td style="text-align:center;white-space: nowrap;min-width:50px">合并组号</td> -->
							...
							<td  style="white-space: nowrap;min-width:60px ">联系人</td>				
							<td  style="white-space: nowrap;min-width:60px ">电话</td>	
							...
							<td  style="text-align:center;white-space: nowrap;min-width:120px">分配时间</td>		
							<td style="text-align:center;white-space: nowrap;min-width:60px">订单号</td>									
							<td  style="text-align:center;white-space: nowrap;min-width:80px">运单号</td>
						</tr>
							...
							%>
								<tr>
									...
									<td  style="white-space: nowrap; ">
										...
										<html:a href="contoller.do?operation=toAssignTransportToLogistics&checkTransportId=$[transportBean.transportId]" style="border:0;text-decoration:none;">
										<input type="button"  id="" name="" value="排车"  class="commonBtn">
										</html:a>
										<%} %>
										<%if(transportStatus==1){//分配承运商未排车的可以取消 %>
											<btn:cancel  href="contoller.do?operation=canncelAssignTransportToLogistics&transportId=$[transportBean.transportId]&sapTransCode=$[transportBean.sapTransCode]"  />
										<%} %>
										
										
										 <cext:priv code="_htms_transport_manage_delete">
										     <html:a href="contoller.do?operation=returnToTransportStatus">
									 ...
									 <td style="white-space: nowrap; text-align:center; ">
									    <%if(transportStatus>=1){ //已经排车的车辆能查看车辆跟踪的状态 %>
									        <html:a href="contoller.do?operation=trackTransfer&transId=$[transportBean.transId]&returnOperation=listTransportToLogistics">
								   ...
								   <!-- 	
									...
									<td style="text-align:center;white-space: nowrap;">
									<html:a style="text-decoration:none;" href="contoller.do?operation=toViewAssignTransportToLogistics&transportId=$[transportBean.transportId]">
									...
									<td  style="text-align:right;"><html:a style="text-decoration:none;" href="contoller.do?operation=toViewAssignTransportToLogistics&transportId=$[transportBean.transportId]"><%=transportBean.getApplyPackNum() %></html:a></td>
									...
									<td style="text-align:center;white-space: nowrap;"><%=transportBean.getCreateTime() %></td>										
		...
		<%--
		<td  style="display:block;text-align:left;width:10px;" align="left">
			<html:div   onclick="ShowOrHideMenu('leftShowArea')" style="float:left;">
    			<html:img src="images/common/framework/show-hide-btn.gif" style="cursor:hand"/>
    		</html:div>
		</td>
		 --%>
		<td>&nbsp;</td>
