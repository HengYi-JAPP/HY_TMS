...
<html:form id="vehicleForm"  enctype="application/x-www-form-urlencoded" loadCache="true" action="contoller.do"  method="GET" >
	<html:hidden id="operation" name="operation" value="listVehicleToLogistics"/>
	...
	<table>
		<tr class="trCell">
			<td   class=""   id="manageBox" colSpan="4" rowSpan="1">
				<btn:new href="contoller.do?operation=toAddVehicleToLogistics"/>
				<btn:delete href="javascript:batchDelete('vehicleForm','checkVehicleId','','deleteVehicleToLogistics');" />
			</td>
		</tr>
	</table>
	...
	<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width:100%; border-collapse: collapse;" align="center" list="vehicleList" bean="vehicleBean" isHead="true" >
		<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
			...
			<html:td  label="{$jsp.htms.logistic.vehicle.vehiclecode#}">
				<html:a  href="contoller.do?operation=viewVehicleToLogistics&isModify=0&vehicleId=$[vehicleBean.vehicleId]">
			...
			<html:td  label="操作">
				<btn:modify href="contoller.do?operation=viewVehicleToLogistics&isModify=1&vehicleId=$[vehicleBean.vehicleId]"/>
				<btn:delete href="contoller.do?operation=deleteVehicleToLogistics&vehicleId=$[vehicleBean.vehicleId]"/>
			</html:td>
		</html:tr>
	</html:table>
