...
String pageHtml = pageCtl.getPaginationHtml("appliedForm");
...
<html>
  ...
  <div class="container">
  <div class="top">
	  <div class="top-left"><a href="contoller.do?operation=appliedMobileList&&userId=<%=userId %>&salesNo=<%=salesNo %>&startDate=<%=appliedStartDate %>"><img src="jsp/htms/mobile/image/button/return.jpg" style="width: 25px;"/></a></div>
	  <%if(corderCodeSH==null){%>
	  	<div class="top-center" style="margin: 5px 21% 1px;"><input type="text" placeholder="输入订单号或客户名" id="corderCodeSH" name="corderCodeSH" value="" style="width: 85%;height: 24px;"/></div>
   		<%}else{ %>
   		<div class="top-center" style="margin: 5px 21% 1px;" ><input type="text" placeholder="输入订单号或客户名" id="corderCodeSH" name="corderCodeSH" value="<%=corderCodeSH %>" style="width: 85%;height: 24px;"/></div>
   		<%} %>
   		<div class="top-right" ><a href="javascript:submit('appliedForm')" ><img src="jsp/htms/mobile/image/button/search.png" style="width: 25px;"/></a></div> 
   	</div>
		<div class="content" >
		...
		<div  class="appliedcon">
			<div style="padding: 0 0 10px 0;"><%=shipTransferBean.getCustomerName()%>	
