  ...
  <body> 
    <div class="container">
   	...
   	<div class="content">
   		...
   		<div class="edit_addr" >
   			...
   			<div class="edit_addr_right">
   				<input input type="text" class="edit_addr_input" readonly="true"  placeholder="选择省" id="picker_province" unselectable="on" onfocus="this.blur()"/>
   		...
   		<div class="edit_addr" >
   			...
   			<div class="edit_addr_right">
   				<input type="text" class="edit_addr_input" readonly="true"  placeholder="选择市" id="picker_city" unselectable="on" onfocus="this.blur()"/>
   				<span><img src="jsp/htms/mobile/image/button/left.jpg" class="custimg"></img></span>
   			</div>
   		</div>
    ...
    function getAreaChild(nodeId, areaLevel) {
   	 ...
   	 function saveAddr() {
   	 	...
   	 	var params = {operation:'modifyCustAddrSave', caddrId:<%=addrId %>, areaCode:selAreaCode, areaId:areaId,caddrDetail:addrDetail,creator:<%=userId %>,createTime:curTime,caddrContactor:name,caddrTelephone:contact,customerId:<%=customerId %>};
        Ajax.get(basePath, params, function(msg){	
