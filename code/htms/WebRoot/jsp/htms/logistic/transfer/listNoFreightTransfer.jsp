...
<html:form id="NoFreightTransferForm"  enctype="application/x-www-form-urlencoded"  action="contoller.do"  method="GET" loadCache="true">
	<com:loader  simplendar="true"  ajax="true" asyncSelect="true" />
	<html:hidden id="operation" name="operation" value="listNoFreightTransfer"/>
	<com:loader binder="true" checkall="true" switchbox="true" ajax="true" />
	<jsp:include page="../../../common/impart/table-banner-new.jsp">
		<jsp:param value='手工生成运费' name="title"/>
	</jsp:include>
	    ...
	    <tr class="trCell">
		 ...
		 <tr class="trCell" style="width:100%" >
		      ...
		      <td    id="searchBox" colSpan="6" rowSpan="1"  align="left" >
		           <btn:search href="javascript:submit('NoFreightTransferForm')"/>
				   <btn:reset href="javascript:cleanForm('NoFreightTransferForm')"/>
		     </td>
		 </tr>
	</table>
				...
				%>
					<tr class="alternatingItemStyle"   onclick="onMouseMoveOverTableList(this)">
						<%if(d==0){
						 %>
				                <td  rowspan="<%=dsize %>">
									  <btn:active href="contoller.do?operation=doPerformGetFreight&corderId=$[transferBean.corderId]&codetailId=$[transferBean.codetailId]&transId=$[transferBean.transId]&transDetailId=$[transferBean.transDetailId]&sapTransCode=$[transferBean.sapTransCode]" name="执行" typeId="applybtn" value="执行"/>
								</td>
								...
								<td style="text-align:center;" rowspan="<%=dsize %>">
								    <html:a style="text-decoration:none;" href="contoller.do?operation=toViewAndModifyTransfer&isModify=3&corderId=$[transferBean.corderId]&codetailId=$[transferBean.codetailId]&transId=$[transferBean.transId]&transDetailId=$[transferBean.transDetailId]&caddrId=$[transferBean.caddrId]">
								       <%=shipCode %>
								    </html:a>
								</td>
	...
	<table id="pageFooter" class="">
		<tr class="trCell">
			<td   class="pagination"   id="pagination" >
				...
				<com:page formId="NoFreightTransferForm" pageCtlName="pageCtl"/>
			</td>
		</tr>
	</table>
</html:form>
