...
<com:loader css="css/common/sub-table-list.css" switchbox="true"/>
	...
	<table  class="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width:100%; border-collapse: collapse;" align="center">
	 ...
	 <%
	     ...
	     for(int i=0;i<transferDetailList.size();i++){
	          ...
	          <tr  style="height:25px;" >
                     ...
                     <td style="text-align:right;" ><%=transDetailBean.getApplyTonNum() %></td>	
                     <td style="text-align:center;" >
                           <p title='<html:value value="$[tranferViewBean.areaName]" />'  >
	                          <html:value value="$[tranferViewBean.areaName]" />
	                       </p>    
                     </td>	
				    ...
				    <td style="text-align:center;" >
				        <%=transPriceBean.getPriceStart()==null?"":transPriceBean.getPriceStart() %>
					</td>
					<td style="text-align:center;" >
				        <%=transPriceBean.getPriceEnd()==null?"":transPriceBean.getPriceEnd() %>
					</td>
					<td style="text-align:center;" >
					...
					<td style="text-align:right;" >						
						<%=freightBean.getPlanFreight()==null?"":freightBean.getPlanFreight() %>
					</td>
					<!-- 
					<td style="text-align:right;" >
						<%=freightBean.getPlanCarrierFreight()==null?"":freightBean.getPlanCarrierFreight() %>
					</td>    --> 
	          </tr>
	          <%
	     }
	 ...
	 <tr height="25px">
	     ...
	     <td  colspan="10"></td>
	     <td style="text-align:right;"><%=freightBean.getPlanTotalFreight()==null?"":freightBean.getPlanTotalFreight() %></td>
	    <!--   <td style="text-align:right;"><%=freightBean.getPlanTotalCarrierFreight()==null?"":freightBean.getPlanTotalCarrierFreight() %></td>  -->
	 </tr>
</table>
	...
	<html:table  cellSpacing="0"  align="center" isHead="false" >
		<html:tr >
			<html:td >	
				...
				<btn:return href="contoller.do?operation=listNoFreightTransfer&curPage=$[curPage]"/>
			</html:td>
		</html:tr>
	</html:table>
