...
<html:form id="sendForm"  enctype="application/x-www-form-urlencoded"  action="contoller.do"  method="GET" loadCache="true" >
	...
	<html:hidden id="operation" name="operation" value="listSend"/>
	...
	<table id="1674" class="edit-talbe">
		...
		<tr class="trCell">
			...
			<td   class="search-box"   id="searchBox"  colSpan="12" rowSpan="1"   style="text-align:right;">
	...
	<table>
		<tr class="trCell">
			...
			<html:a href="javascript:void(0);" style="border:0;text-decoration:none;">
				<input type="button"  id="" name="" value="派车"  onclick="javascript:batchDelete('sendForm','checkSendId','','doSendCar');" class="commonBtn">
			</html:a>
			</td>
		</tr>
	  </table>
	...
	<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width:100%; border-collapse: collapse;" align="center" list="sendList" bean="sendBean" isHead="true" >
		<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
			...
			<html:td  label="{$jsp.htms.logistic.send.sendcode#}"  property="" >
				<html:a href="contoller.do?operation=toViewSendTransport&isModify=0&sendId=$[sendBean.sendId]">
			...
			<html:td  label="司机"  property="driverName"  width="55px"/>
			...
			<html:td  label="操作">
				<logic:if condition="$[sendBean.sendStatus]==0">
					<html:a href="contoller.do?operation=doSendCar&checkSendId=$[sendBean.sendId]" style="border:0;text-decoration:none;">
