...
<html:form id="driverForm"  enctype="application/x-www-form-urlencoded" loadCache="true" action="contoller.do"  method="GET" >
	<html:hidden id="operation" name="operation" value="listDriver"/>
	...
	<table>
		<tr class="trCell">
			<td   class=""   id="manageBox" colSpan="4" rowSpan="1">
				<btn:new href="contoller.do?operation=toAddDriver"/>
				<btn:delete href="javascript:batch_deletes('driverForm','checkDriverId','','deleteDriver');" />
			</td>
		</tr>
	</table>
	...
	<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width:100%; border-collapse: collapse;" align="center" list="driverList" bean="driverBean" isHead="true" >
		<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
			...
			<html:td  label="{$jsp.htms.logistic.driver.drivercode#}">
				<html:a href="contoller.do?operation=viewDriver&isModify=0&driverId=$[driverBean.driverId]"><html:value value="$[driverBean.driverCode]"></html:value> </html:a>
			</html:td>
			<html:td  label="{$jsp.htms.logistic.driver.drivername#}">
				<html:a href="contoller.do?operation=viewDriver&isModify=0&driverId=$[driverBean.driverId]"><html:value value="$[driverBean.driverName]"></html:value> </html:a>
			</html:td>
			...
			<html:td  label="操作">
				<btn:modify href="contoller.do?operation=viewDriver&isModify=1&driverId=$[driverBean.driverId]"/>
				<btn:delete href="javascript:deleteRow('contoller.do?operation=deleteDriver&driverId=$[driverBean.driverId]')"/>
			</html:td>
		</html:tr>
	</html:table>
