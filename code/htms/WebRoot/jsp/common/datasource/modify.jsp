...
<html:form id="datasourceForm" name="datasourceForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifyDatasource"/>
			<html:hidden name="dbsId" id="dbsId"  value="datasourceViewBean.dbsId"/>
			<jsp:include page="../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.common.datasurce.modify.title") %>' name='title'/>	
			</jsp:include>
...
<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">
				...
				<html:tr>
					...
					<html:td >						
							<html:text name="dbsName" id="dbsName" styleClass="input-text" size="36" maxlength="60" value="datasourceViewBean.dbsName"/>							
					</html:td>
				</html:tr>
				<html:tr>
				...
				<html:tr>
					...
					<html:td >
							<html:text name="dbName" id="dbName" styleClass="input-text" size="36"  value="datasourceViewBean.dbName"/>													
					</html:td>
				</html:tr>				
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:value value="{$jsp.common.datasurce.hostip#}"/></html:td>
					<html:td>
							<html:text name="hostIp" id="hostIp" styleClass="input-text" size="36"  value="datasourceViewBean.hostIp"/>				
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:value value="{$jsp.common.datasurce.hostport#}"/></html:td>
					<html:td >
							<html:text name="hostPort" id="hostPort" styleClass="input-text" size="36"  value="datasourceViewBean.hostPort"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:value value="{$jsp.common.datasurce.dbaccount#}"/></html:td>
					<html:td >
							<html:text name="dbAccount" id="dbAccount" styleClass="input-text" size="36"  value="datasourceViewBean.dbAccount"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:value value="{$jsp.common.datasurce.dbpwd#}"/></html:td>
					<html:td >
							<html:password name="dbPwd" id="dbPwd" styleClass="input-text" size="36"  value="datasourceViewBean.dbPwd"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:value value="{$jsp.common.datasurce.maxconn#}"/></html:td>
					<html:td >
							<html:text name="maxConn" id="maxConn" styleClass="input-text" size="36"  value="datasourceViewBean.maxConn"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:value value="{$jsp.common.datasurce.vstatus#}"/></html:td>
					<html:td>
					<com:switchbox varValue="datasourceViewBean.isValidate" talbeName="TB_DATASOURCE" idValue="datasourceViewBean.dbsId" offValue="0" varName="isValidate" onValue="1"  idName="dbsId" offLabel="{$jsp.common.status.validate.invalidate#}" onLabel="{$jsp.common.status.validate.validate#}"  ajaxUrl="contoller.do"/>									
					</html:td>
				</html:tr>
			</html:table>
