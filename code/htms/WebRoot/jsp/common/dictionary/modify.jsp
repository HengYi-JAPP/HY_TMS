...
<html:form id="dictionaryForm" name="dictionaryForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifyDictionary"/>
			<html:hidden name="dicId" id="dicId"  value="dictionaryViewBean.dicId"/>			 
			<jsp:include page="../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.common.dictionary.modify.title") %>' name='title'/>	
			</jsp:include>
...
<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">
				...
				<html:tr>
					...
					<html:td >	
						<html:text name="dicCode" id="dicCode" styleClass="input-text" value="dictionaryViewBean.dicCode" /> 											
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.dictionary.name#}"/></html:td>
					<html:td >
							<html:text name="dicName" id="dicName" styleClass="input-text" value="dictionaryViewBean.dicName"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.dictionary.desc#}"/></html:td>
					<html:td>
							<html:textarea name="dicDesc" id="dicDesc" styleClass="input-text" cols="40" rows="8"   value="dictionaryViewBean.dicDesc"></html:textarea>				
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.dictionary.order#}"/></html:td>
					<html:td >
							<html:text name="showOrder" id="showOrder" styleClass="input-text" value="dictionaryViewBean.showOrder"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.status.validate#}"/></html:td>
					<html:td>
					<com:switchbox varValue="dictionaryViewBean.isValidate" talbeName="TB_DICTIONARY" idValue="dictionaryViewBean.dicId" offValue="0" varName="isValidate" onValue="1"  idName="dicId" offLabel="{$jsp.common.status.validate.invalidate#}" onLabel="{$jsp.common.status.validate.validate#}"  ajaxUrl="contoller.do"/>									
					</html:td>
				</html:tr>
			</html:table>
