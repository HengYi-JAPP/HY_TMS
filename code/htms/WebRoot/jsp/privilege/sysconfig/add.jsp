...
<html:form id="sysConfigForm" name="sysConfigForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="addSysConfig"/>
			<html:hidden name="sysId" id="sysId"  value="sysId"/>	
			<html:hidden name="configId" id="configId"  value="<%=tools.tool.getRandomUUID(64) %>"/>		
			<html:hidden name="isValidate" id="isValidate" value="1"/> 
			<jsp:include page="../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.privilege.sysconfig.add.title") %>' name='title'/>	
			</jsp:include>
...
<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">
				...
				<html:tr>
					...
					<html:td >						
							<html:text name="configCode" id="configCode" styleClass="input-text"/>							
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.privilege.sysconfig.name#}"/></html:td>
					<html:td >	
						<html:text name="configName" id="configName" styleClass="input-text"/> 											
					</html:td>
				</html:tr>
				<html:tr>
					...
					<html:td>
							...
							<com:fckeditor instanceName="configContent" width="600" height="400"></com:fckeditor>				
					</html:td>
				</html:tr>	
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.privilege.sysconfig.desc#}"/></html:td>
					<html:td>
							<html:textarea name="configDesc" id="configDesc" styleClass="input-text" cols="40" rows="8"></html:textarea>				
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.privilege.sysconfig.version#}"/></html:td>
					<html:td >
							<html:text name="versionNo" id="versionNo" styleClass="input-text"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.privilege.sysconfig.isref#}"/></html:td>
					<html:td >
							<com:switchbox boxId="isRef" boxName="isRef" varValue="0" talbeName="TB_SYSTEM" idValue="isRef" offValue="0" varName="isRef" onValue="1"  idName="isRef" offLabel="{$jsp.privilege.sysconfig.isref.no#}" onLabel="{$jsp.privilege.sysconfig.isref.yes#}"  ajaxUrl="contoller.do" isSave="false"/>												
					</html:td>
				</html:tr>
			</html:table>
	...
	<com:validator formId="groupForm" showNormal="true" submitValidate="true" >
		...
		<com:vElement id="versionNo"  types="number" event="onblur">
			<com:init maxlength="10" initValue="10"></com:init>
		</com:vElement>
	</com:validator>
