...
<html:form id="roleForm" name="roleForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="assignChannelForRole"/>
			<html:hidden id="sysId" name="sysId" value="sysId"/>
			

			<jsp:include page="../../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.portal.console.subconsole.role.channel.title") %>' name="title"/>		
			</jsp:include>
...
<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
				...
				<html:tr>
					...
					<com:lorbox lorBoxName="lorbox" filtDuplicated="true">
						<com:leftbox itemId="channelId" list="channelList" itemValue="channelId" itemLabel="channelName" boxId="canSelectChannel" orader="false" boxLabel="{$jsp.portal.console.subconsole.role.channel.selectable#}"/>
						<com:rightbox itemId="channelId" list="channelCheckedList" itemValue="channelId" itemLabel="channelName" boxId="selectedChannel"  orader="false"  boxLabel="{$jsp.portal.console.subconsole.role.channel.selected#}"/>
					</com:lorbox>	
