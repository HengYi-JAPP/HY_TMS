...
<html:form id="groupForm" name="groupForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="addSubSystemGroup"/>
...
<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
			...
			<html:table  cellSpacing="0"  align="center" isHead="false" >
				<html:tr ><html:td >
					<cext:priv code="_subsystem_group_manage_new_save">	
						<btn:save href="javascript:__vsubmit('groupForm')"/>
					</cext:priv>
					<cext:priv code="_subsystem_group_manage_new_return">	
						<btn:return href="contoller.do?operation=listSubSystemGroup"/>
					</cext:priv>							
				</html:td></html:tr>
			</html:table>	
