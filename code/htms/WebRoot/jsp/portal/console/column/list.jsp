...
<html>
	...
	<html:form id="columnForm" name="columnForm" method="post" action="contoller.do">
		<html:hidden id="operation" name="operation" value="listColumn"/>
		...
		<html:table cellSpacing="0" style="width: 100%;" align="center">
			<html:tr>
				<html:td>
				<btn:new href="contoller.do?operation=toAddColumn"/>
				<btn:delete href="javascript:batchDelete('columnForm','checkColumnId','','deleteColumn');" />
				<btn:button name="{$jsp.portal.console.column.params.title#}" onclick="javascript:checkBeforeSubmit('columnForm','checkColumnId','','listColumnParams',true);" typeId="addParamsForColumn" value="{$jsp.portal.console.column.params.title#}" styleClass="button-self-style"/>
				</html:td>
			</html:tr>
		</html:table>
		...
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="<%=PropKey.COLUMN_LIST%>" bean="columnBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				...
				<html:a href="contoller.do?operation=viewColumn&columnId=$[columnBean.columnId]">
				...
				<html:td label="{$jsp.common.operation.modify#}" width="80px">
					<btn:modify href="contoller.do?operation=viewColumn&isModify=true&columnId=$[columnBean.columnId]"/>
				</html:td>
				<html:td label="{$jsp.common.operation.delete#}" width="80px">
					<btn:delete  href="contoller.do?operation=deleteColumn&checkColumnId=$[columnBean.columnId]"/>
				</html:td>
			</html:tr>
		</html:table>	
