...
<html:form id="queryForm" name="queryForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifySQLQuery"/>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
				...
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.plugin.sqlquery.system#}"/></html:td>
					<html:td >						
						...
						<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.plugin.sqlquery.column#}"/></html:td>
					<html:td >
			...
			<html:table  cellSpacing="0"  align="center" isHead="false" >
				<html:tr ><html:td >
						...
						<btn:return href="contoller.do?operation=listSQLQuery&infoTypeCode=sqlquery"/>								
				</html:td></html:tr>
			</html:table>	
