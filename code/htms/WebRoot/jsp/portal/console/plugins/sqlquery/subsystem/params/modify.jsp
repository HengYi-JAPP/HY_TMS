...
<html:form id="paramForm" name="paramForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifySubSystemSQLQueryParams"/>
			
			<html:hidden id="paramId" name="paramId" value="sqlqueryParamsViewBean.paramId"/>
			<html:hidden id="checkQueryId" name="checkQueryId" value="sqlqueryParamsViewBean.queryId"/>
			...
			<jsp:include page="../../../../../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.portal.console.plugin.sqlquery.params.modify.title") %>' name='title'/>		
			</jsp:include>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
				...
				<html:tr>
					...
					<html:td >
							<html:text name="paramCode" id="paramCode" styleClass="input-text" size="36"   value="sqlqueryParamsViewBean.paramCode"/>													
					</html:td>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.plugin.sqlquery.params.name#}"/></html:td>
					<html:td >
							<html:text name="paramName" id="paramName" styleClass="input-text" size="36"   value="sqlqueryParamsViewBean.paramName"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.plugin.sqlquery.params.var#}"/></html:td>
					<html:td >
						<html:text name="paramVar" id="paramVar" styleClass="input-text" size="36"   value="sqlqueryParamsViewBean.paramVar"/>														
					</html:td>	
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.plugin.sqlquery.params.value#}"/></html:td>
					<html:td >
						<html:text name="paramValue" id="paramValue" styleClass="input-text" size="36"   value="sqlqueryParamsViewBean.paramValue"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.plugin.sqlquery.params.desc#}"/></html:td>
					<html:td colspan="3">
							<html:textarea name="paramDesc" id="paramDesc" styleClass="input-text" cols="40" rows="8" value="sqlqueryParamsViewBean.paramDesc"></html:textarea>	
					</html:td>
				</html:tr>
