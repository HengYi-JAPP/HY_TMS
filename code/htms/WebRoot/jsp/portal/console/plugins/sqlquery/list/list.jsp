...
<html>
	...
	<html:form id="listForm" name="listForm" method="post" action="contoller.do">
		<html:hidden id="operation" name="operation" value="toListSQLQueryList"/>
		...
		<html:table cellSpacing="0" style="width: 100%;" align="center">
			<html:tr>
				<html:td>
				<btn:new href="jsp/portal/console/plugins/sqlquery/list/add.jsp?checkQueryId=$[checkQueryId]"/>
				<btn:delete href="javascript:batchDelete('listForm','checkConfigId','','deleteSQLQueryList');" />
		...
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="<%=PropKey.SQLQUERY_LIST_LIST%>" bean="listBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				...
				<html:a href="contoller.do?operation=viewSQLQueryList&configId=$[listBean.configId]&checkQueryId=$[checkQueryId]">
				...
				<html:td label="{$jsp.common.operation.modify#}" width="80px">
					<btn:modify href="contoller.do?operation=viewSQLQueryList&isModify=true&configId=$[listBean.configId]&checkQueryId=$[checkQueryId]"/>
				</html:td>
				<html:td label="{$jsp.common.operation.delete#}" width="80px">
					<btn:delete  href="contoller.do?operation=deleteSQLQueryList&checkConfigId=$[listBean.configId]&checkQueryId=$[checkQueryId]"/>
				</html:td>
			</html:tr>
		</html:table>	
