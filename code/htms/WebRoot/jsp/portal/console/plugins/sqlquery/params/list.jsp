...
<html>
	...
	<html:form id="paramForm" name="paramForm" method="post" action="contoller.do">
		<html:hidden id="operation" name="operation" value="toListSQLQueryParams"/>
		...
		<html:table cellSpacing="0" style="width: 100%;" align="center">
			<html:tr>
				<html:td>
				<btn:new href="jsp/portal/console/plugins/sqlquery/params/add.jsp?checkQueryId=$[checkQueryId]"/>
				<btn:delete href="javascript:batchDelete('paramForm','checkParamId','','deleteSQLQueryParams');" />
				<btn:return href="contoller.do?operation=listSQLQuery"/>
			    </html:td>
			</html:tr>
		</html:table>
		...
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="<%=PropKey.SQLQUERY_PARAMS_LIST%>" bean="paramBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				...
				<html:td  label="名称" >
				<html:a href="contoller.do?operation=viewSQLQueryParams&paramId=$[paramBean.paramId]&checkQueryId=$[checkQueryId]">
				...
				<html:td label="{$jsp.common.operation.modify#}" width="80px">
					<btn:modify href="contoller.do?operation=viewSQLQueryParams&isModify=true&paramId=$[paramBean.paramId]&checkQueryId=$[checkQueryId]"/>
				</html:td>
				<html:td label="{$jsp.common.operation.delete#}" width="80px">
					<btn:delete  href="contoller.do?operation=deleteSQLQueryParams&checkParamId=$[paramBean.paramId]&checkQueryId=$[checkQueryId]"/>
				</html:td>
			</html:tr>
		</html:table>	
