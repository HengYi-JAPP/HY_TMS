...
<html>
	...
	<html:form id="paramForm" name="paramForm" method="post" action="contoller.do">
		<html:hidden id="operation" name="operation" value="toListSubSystemServiceParams"/>
		...
		<html:table cellSpacing="0" style="width: 100%;" align="center">
			<html:tr>
				<html:td>
				<btn:new href="jsp/portal/console/plugins/service/params/add.jsp?checkServiceId=$[checkServiceId]&sysId=$[sysId]&columnId=$[columnId]"/>
				<btn:delete href="javascript:batchDelete('paramForm','checkParamId','','deleteSubSystemServiceParams');" />
				<btn:return href="contoller.do?operation=listSubSystemService&sysId=$[sysId]&columnId=$[columnId]&curpage=1"/>
			    </html:td>
			</html:tr>
		</html:table>
		...
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="<%=PropKey.SERVICE_PARAMS_LIST%>" bean="paramBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				...
				<html:a href="contoller.do?operation=viewSubSystemServiceParams&paramId=$[paramBean.paramId]&checkServiceId=$[checkServiceId]&sysId=$[sysId]&columnId=$[columnId]">
				...
				<html:td label="{$jsp.common.operation.modify#}" width="80px">
					<btn:modify href="contoller.do?operation=viewSubSystemServiceParams&isModify=true&paramId=$[paramBean.paramId]&checkServiceId=$[checkServiceId]&sysId=$[sysId]&columnId=$[columnId]"/>
				</html:td>
				<html:td label="{$jsp.common.operation.delete#}" width="80px">
					<btn:delete  href="contoller.do?operation=deleteSubSystemServiceParams&checkParamId=$[paramBean.paramId]&checkServiceId=$[checkServiceId]&sysId=$[sysId]&columnId=$[columnId]"/>
				</html:td>
			</html:tr>
		</html:table>	
