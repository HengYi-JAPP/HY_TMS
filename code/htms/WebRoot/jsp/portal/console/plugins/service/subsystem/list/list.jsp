...
<html>
	...
	<html:form id="listForm" name="listForm" method="post" action="contoller.do">
		<html:hidden id="operation" name="operation" value="toListSubSystemServiceList"/>
		...
		<html:table cellSpacing="0" style="width: 100%;" align="center">
			<html:tr>
				<html:td>
				<btn:new href="jsp/portal/console/plugins/service/list/add.jsp?checkServiceId=$[checkServiceId]&sysId=$[sysId]&columnId=$[columnId]"/>
				<btn:delete href="javascript:batchDelete('listForm','checkConfigId','','deleteSubSystemServiceList');" />
		...
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="<%=PropKey.SERVICE_LIST_LIST%>" bean="listBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				...
				<html:a href="contoller.do?operation=viewSubSystemServiceList&configId=$[listBean.configId]&checkServiceId=$[checkServiceId]&sysId=$[sysId]&columnId=$[columnId]">
				...
				<html:td label="{$jsp.common.operation.modify#}" width="80px">
					<btn:modify href="contoller.do?operation=viewSubSystemServiceList&isModify=true&configId=$[listBean.configId]&checkServiceId=$[checkServiceId]&sysId=$[sysId]&columnId=$[columnId]"/>
				</html:td>
				<html:td label="{$jsp.common.operation.delete#}" width="80px">
					<btn:delete  href="contoller.do?operation=deleteSubSystemServiceList&checkConfigId=$[listBean.configId]&checkServiceId=$[checkServiceId]&sysId=$[sysId]&columnId=$[columnId]"/>
				</html:td>
			</html:tr>
		</html:table>	
