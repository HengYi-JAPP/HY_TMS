...
<html>
	...
	<html:form id="refForm" name="refForm" method="post" action="contoller.do">
		<html:hidden id="operation" name="operation" value="listWebRef"/>
		
		<jsp:include page="../../../../common/impart/table-banner.jsp">
			<jsp:param value='<%=tools.tool.getLocal("jsp.portal.console.plugin.webref.list.title") %>' name='title'/>
		...
		<html:table id="searchConditionBox" style="width: 100%;" align="center" cellPadding="0" cellSpacing="0">
			<html:tr>
				...
				<html:td styleClass="condition_option">
					<html:text name="refNameSH" id="refNameSH"  maxlength="30" styleClass="input_text" />					
								
						<btn:search href="javascript:__vsubmit('refForm')"/>
						<btn:reset href="javascript:cleanForm('refForm')"/>						
				</html:td>
			</html:tr>
		</html:table>
		...
		<html:table cellSpacing="0" style="width: 100%;" align="center">
			<html:tr>
				<html:td>
				<btn:new href="contoller.do?operation=toAddWebRef"/>
				<btn:delete href="javascript:batchDelete('refForm','checkInfoId','','deleteWebRef');" />
		...
		<!-- list box 内容列表区 -->
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="<%=PropKey.WEB_REF_LIST%>" bean="infoBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				...
				<html:a href="contoller.do?operation=toViewWebRef&infoId=$[infoBean.infoId]">
					<html:value value="infoBean.refName"/>
				</html:a>				
				</html:td>
				<html:td  label="{$jsp.portal.console.plugin.webpart.desc#}"  property="refDesc" />
				
				<html:td label="{$jsp.common.operation.modify#}" width="80px">
					<btn:modify href="contoller.do?operation=toViewWebRef&isModify=true&infoId=$[infoBean.infoId]&infoTypeCode=webRef"/>
				</html:td>
				<html:td label="{$jsp.common.operation.delete#}" width="80px">
					<btn:delete  href="contoller.do?operation=deleteWebRef&checkInfoId=$[infoBean.infoId]&infoTypeCode=webRef"/>
				</html:td>
			</html:tr>
		</html:table>	
		<com:checkall targetName="checkInfoId" checkId="checkAll"/>	
		<com:page formId="refForm" pageCtlName="<%=PropKey.PAGE_CTL%>"/>
	</html:form>
