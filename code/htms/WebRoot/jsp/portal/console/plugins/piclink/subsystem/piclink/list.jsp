	...
	<html:form id="linkForm" name="linkForm" method="post" action="contoller.do">
		...
		<html:table id="searchConditionBox" style="width: 100%;" align="center" cellPadding="0" cellSpacing="0">
			...
			<html:tr>
					...
					<html:td styleClass="condition_option">
						<html:select id="linkGroupIdSH" name="linkGroupIdSH"  fistOption="{$jsp.common.select.firstoption#}"   isCascade="true" isCascadeEdit="true" cascadeSource="linkTypeIdSH" cascadeValue="linkTypeId" list="<%=PropKey.LINK_GROUP_LIST%>">
		...
		<html:table cellSpacing="0" style="width: 100%;" align="center">
			<html:tr>
				<html:td>
				<btn:new href="jcontoller.do?operation=toAddSubSystemPicLink&sysId=$[sysId]&columnId=$[columnId]"/>
				<btn:delete href="javascript:batchDelete('linkForm','checkLinkId','','deletePicLink');" />
				<btn:button name="{$jsp.portal.console.plugin.piclinktype.list.title#}" href="contoller.do?operation=listSubSystemPicLinkType&sysId=$[sysId]&columnId=$[columnId]" typeId="assignPrivilege" value="{$jsp.portal.console.plugin.piclinktype.list.title#}" styleClass="button-self-style"/>
				<btn:button name="{$jsp.portal.console.plugin.piclinkgroup.list.title#}" href="contoller.do?operation=listSubSystemPicLinkGroup&sysId=$[sysId]&columnId=$[columnId]" typeId="assignPrivilege" value="{$jsp.portal.console.plugin.piclinkgroup.list.title#}" styleClass="button-self-style"/>
				</html:td>
			</html:tr>
		</html:table>
		...
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="<%=PropKey.LINK_LIST%>" bean="linkBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				...
				<html:td  label="{$jsp.portal.console.plugin.piclinks.name#}" >
					<html:a href="contoller.do?operation=viewSubSystemPicLink&linkId=$[linkBean.linkId]&sysId=$[sysId]&columnId=$[columnId]">
				...
				<html:td label="{$jsp.common.operation.modify#}" width="80px">
					<btn:modify href="contoller.do?operation=viewSubSystemPicLink&isModify=true&linkId=$[linkBean.linkId]&sysId=$[sysId]&columnId=$[columnId]"/>
				</html:td>
				<html:td label="{$jsp.common.operation.delete#}" width="80px">
					<btn:delete  href="contoller.do?operation=deleteSubSystemPicLink&checkLinkId=$[linkBean.linkId]&sysId=$[sysId]&columnId=$[columnId]"/>
				</html:td>
			</html:tr>
		</html:table>	
