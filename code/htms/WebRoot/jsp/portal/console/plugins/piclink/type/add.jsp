...
<html:form id="piclinkForm" name="piclinkForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="addPicLinkType"/>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">
				<html:tr>
					...
					<html:td >
							<html:text name="linkTypeCode" id="linkTypeCode" styleClass="input-text" size="40"  value=""/>													
					</html:td>
				</html:tr>				
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.plugin.piclinktype.name#}"/></html:td>
					<html:td >
							<html:text name="linkTypeName" id="linkTypeName" styleClass="input-text" size="40"  value=""/>													
					</html:td>
				</html:tr>
