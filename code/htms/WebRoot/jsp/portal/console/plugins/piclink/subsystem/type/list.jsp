...
<html>
	...
	<html:form id="linkTypeForm" name="linkTypeForm" method="post" action="contoller.do">
		<html:hidden id="operation" name="operation" value="listSubSystemPicLinkType"/>
		...
		<html:table cellSpacing="0" style="width: 100%;" align="center">
			<html:tr>
				<html:td>
				<btn:new href="jsp/portal/console/plugins/piclink/subsystem/type/add.jsp?sysId=$[sysId]&columnId=$[columnId]"/>
				<btn:delete href="javascript:batchDelete('linkTypeForm','checkLinkTypeId','','deleteSubSystemPicLinkType');" />
		...
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="<%=PropKey.LINK_TYPE_LIST%>" bean="linkTypeBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				...
				<html:a href="contoller.do?operation=viewSubSystemPicLinkType&linkTypeId=$[linkTypeBean.linkTypeId]&sysId=$[sysId]&columnId=$[columnId]">
				...
				<html:td label="{$jsp.common.operation.modify#}" width="80px">
					<btn:modify href="contoller.do?operation=viewSubSystemPicLinkType&isModify=true&linkTypeId=$[linkTypeBean.linkTypeId]&sysId=$[sysId]&columnId=$[columnId]"/>
				</html:td>
				<html:td label="{$jsp.common.operation.delete#}" width="80px">
					<btn:delete  href="contoller.do?operation=deleteSubSystemPicLinkType&checkLinkTypeId=$[linkTypeBean.linkTypeId]&sysId=$[sysId]&columnId=$[columnId]"/>
				</html:td>
			</html:tr>
		</html:table>	
