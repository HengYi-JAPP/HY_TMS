...
<html>
	...
	<html:form id="linkGroupForm" name="linkGroupForm" method="post" action="contoller.do">
		<html:hidden id="operation" name="operation" value="listPicLinkGroup"/>
		...
		<html:table cellSpacing="0" style="width: 100%;" align="center">
			<html:tr>
				<html:td>
				<btn:new href="jcontoller.do?operation=toAddPicLinkGroup&sysId=$[sysId]"/>
				<btn:delete href="javascript:batchDelete('linkGroupForm','checkLinkGroupId','','deletePicLinkGroup');" />
				<btn:button name="分配权限" onclick="javascript:checkBeforeSubmit('linkGroupForm','checkLinkGroupId','','toAddRoleForLinkGroup',true);" typeId="assignPrivilege" value="分配权限" styleClass="button-self-style"/>
				</html:td>
			</html:tr>
		</html:table>
		...
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="<%=PropKey.LINK_GROUP_LIST%>" bean="linkGroupBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				...
				<html:a href="contoller.do?operation=viewPicLinkGroup&linkGroupId=$[linkGroupBean.linkGroupId]&sysId=$[sysId]">
				...
				<html:td label="{$jsp.common.operation.modify#}" width="80px">
					<btn:modify href="contoller.do?operation=viewPicLinkGroup&isModify=true&linkGroupId=$[linkGroupBean.linkGroupId]&sysId=$[sysId]"/>
				</html:td>
				<html:td label="{$jsp.common.operation.delete#}" width="80px">
					<btn:delete  href="contoller.do?operation=deletePicLinkGroup&checkLinkGroupId=$[linkGroupBean.linkGroupId]&sysId=$[sysId]"/>
				</html:td>
			</html:tr>
		</html:table>	
