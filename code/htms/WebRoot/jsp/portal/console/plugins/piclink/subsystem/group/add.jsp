...
<html:form id="piclinkForm" name="piclinkForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="addSubSystemPicLinkGroup"/>
		...
		<html:hidden id="columnId" name="columnId" value="columnId"/>
			<jsp:include page="../../../../../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.portal.console.plugin.piclinkgroup.add.title") %>' name='title'/>	
			</jsp:include>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">
				...
				<html:tr>
					...
					<html:td >
							<html:text name="linkGroupCode" id="linkGroupCode" styleClass="input-text"/>													
					</html:td>
				</html:tr>				
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.plugin.piclinkgroup.name#}"/></html:td>
					<html:td >
							<html:text name="linkGroupName" id="linkGroupName" styleClass="input-text"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.plugin.piclinkgroup.showname#}"/></html:td>
					<html:td >						
						<com:switchbox boxId="showGroupName" varValue="1" idValue="showGroupName" offValue="0" varName="showGroupName" onValue="1"  idName="linkGroupId"  offLabel="{$jsp.portal.console.plugin.piclinkgroup.showname.no#}" onLabel="{$jsp.portal.console.plugin.piclinkgroup.showname.yes#}"  isSave="false" />									
					</html:td>		
				</html:tr>
				<html:tr>
				...
				<html:tr>
					...
					<html:td >
							<html:textarea name="linkGroupDesc" id="linkGroupDesc" styleClass="input-text" cols="60" rows="8"></html:textarea>													
					</html:td>
				</html:tr>
			</html:table>
	...
	<com:validator formId="piclinkForm" showNormal="true" submitValidate="true" >	
		<com:vElement id="showOrder"  types="number" event="onblur">
			<com:init size="40" maxlength="10" initValue="10"></com:init>
		</com:vElement>
