...
<html:form id="piclinkForm" name="piclinkForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="addSubSystemPicLink"/>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">
				...
				<html:tr>
					...
					<html:td >
							<html:text name="linkName" id="linkName" styleClass="input-text" size="40"  value="" onblur="if(!document.getElementById('linkTitle').value){document.getElementById('linkTitle').value=this.value;}"/>													
					</html:td>
				...
				<html:tr>
					...
					<html:td >
							<html:text name="drafter" id="drafter" styleClass="input-text" />													
					</html:td>
	...
	<com:validator formId="piclinkForm" showNormal="true" submitValidate="true" >	
		...
		<com:vElement id="linkIconWidth"  types="none" event="onblur">
			<com:init size="40" maxlength="5" initValue="48"></com:init>
		</com:vElement>
