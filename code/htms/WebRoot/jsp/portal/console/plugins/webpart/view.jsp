...
<com:loader css="css/common/table-list.css"/>
			...
			<jsp:include page="../../../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.portal.console.plugin.webpart.view.title") %>' name='title'/>	
			</jsp:include>
