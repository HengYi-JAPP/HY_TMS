...
<html:form id="newsForm" name="newsForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="addNews"/>
			
			<jsp:include page="../../../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.portal.console.plugin.news.add.title") %>' name='title'/>		
			</jsp:include>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
				...
				<html:tr>
					...
					<html:table  cellSpacing="0"  align="left" isHead="false" >
						<html:tr >
						<html:td >
							<html:hidden id="indexPic" name="indexPic" value=""/>
							<html:div id="showIndexPic"></html:div>				
						</html:td>
						<html:td >	
			...
			<html:table  cellSpacing="0"  align="center" isHead="false" >
				<html:tr ><html:td >
						...
						<btn:return href="contoller.do?operation=listNews"/>							
				</html:td></html:tr>
			</html:table>	
