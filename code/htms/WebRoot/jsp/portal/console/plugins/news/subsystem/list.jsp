...
<html>
	<head>
		...
		<com:loader binder="true" checkall="true" switchbox="true" ajax="true" switchButton="true"/>	
	</head>
	<body>
			<!-- banner 页面导航条 -->
	<html:form id="newsForm" name="newsForm" method="post" action="contoller.do">
		<html:hidden id="operation" name="operation" value="listSubSystemNews"/>
		...
		<html:table cellSpacing="0" style="width: 100%;" align="center">
			<html:tr>
				<html:td>
				<btn:new href="jsp/portal/console/plugins/news/subsystem/add.jsp?columnId=$[columnId]"/>
				<btn:delete href="javascript:batchDelete('newsForm','checkInfoId','','deleteSubSystemNews');" />
				</html:td>
			</html:tr>
		</html:table>
		...
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="<%=PropKey.NEWS_LIST%>" bean="newsBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				...
				<html:a href="contoller.do?operation=viewSubSystemNews&infoId=$[newsBean.infoId]&columnId=$[columnId]">
				...
				<html:td label="{$jsp.portal.console.plugin.news.aprrovestatus#}" >
					<com:switchButton talbeName="TB_WSM_INFO_COLUMN" idValue="newsBean.infoId" statusName="APPROVESTATUS" idName="INFOID" statusValue="newsBean.approveStatus" isSave="true">
				...
				<html:td label="{$jsp.common.operation.modify#}" width="80px">
					<btn:modify href="contoller.do?operation=viewSubSystemNews&isModify=true&infoId=$[newsBean.infoId]&columnId=$[columnId]"/>
				</html:td>
				<html:td label="{$jsp.common.operation.delete#}" width="80px">
					<btn:delete  href="contoller.do?operation=deleteSubSystemNews&checkInfoId=$[newsBean.infoId]&columnId=$[columnId]"/>
				</html:td>
			</html:tr>
		</html:table>	
