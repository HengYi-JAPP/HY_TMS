...
<html:form id="compositeForm" name="compositeForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifyChannelComposite"/>
			<html:hidden id="sysId" name="sysId" value="compositeViewBean.sysId"/>
...
<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">	
				...
				<html:tr>
					...
					<html:td >	
						<com:simpleUpload fileId="beforeIcon" sortDir="themes/icons/system_$[sysId]" isImage="true" viewPath="compositeViewBean.beforeIcon"></com:simpleUpload>								
					</html:td>	
				</html:tr>
				<html:tr>			
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.icon.after#}"/></html:td>
					<html:td >
						<com:simpleUpload fileId="afterIcon" sortDir="themes/icons/system_$[sysId]" isImage="true" viewPath="compositeViewBean.afterIcon"></com:simpleUpload>													
					</html:td>
				</html:tr>
				<html:tr>
