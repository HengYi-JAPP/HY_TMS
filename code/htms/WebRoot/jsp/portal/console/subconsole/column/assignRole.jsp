...
<html:form id="columnForm" name="columnForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="doAddRoleForSubSystemColumn"/>
...
<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
				...
				<html:tr>
					...
					<com:lorbox lorBoxName="lorbox" filtDuplicated="true">
						...
						<com:rightbox itemId="roleId" list="roleOfColumn" itemValue="roleId" itemLabel="roleName" boxId="selectedRole"  orader="false"  boxLabel="{$jsp.privilege.group.assignrole.selected.role#}"/>
					</com:lorbox>	
