...
<html:form id="columnForm" name="columnForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifySubSystemColumn"/>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
				...
				<html:tr>
					...
					<html:td >						
						...
						<html:select id="infoTypeId" name="infoTypeId"  list="<%=PropKey.INFOTYPE_LIST%>" >
							<html:option label="infoTypeName" value="infoTypeId" selected="$[columnViewBean.infoTypeId]"/>
						</html:select>									
					</html:td>	
				</html:tr>
				<html:tr>
					...
					<html:td >						
						<html:text name="columnLoader" id="columnLoader" styleClass="input-text" value="columnViewBean.columnLoader"/>										
					</html:td>				
				...
				<html:tr>
					...
					<html:td >						
						<html:text name="defaultOrder" id="defaultOrder" styleClass="input-text" size="36"  value="columnViewBean.defaultOrder"/>									
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.column.defaultshow#}"/></html:td>
					<html:td >
						<com:switchbox boxId="defaultShow" varValue="columnViewBean.defaultShow" idValue="defaultShow" offValue="0" varName="defaultShow" onValue="1"  idName="defaultShow"  offLabel="{$jsp.portal.console.column.personalize.no#}" onLabel="{$jsp.portal.console.column.personalize.yes#}"   isSave="false" /> 														
					</html:td>
				</html:tr>
				...
				<html:tr>
					...
					<html:td >						
						<com:switchbox boxId="defaultOpen" varValue="columnViewBean.defaultOpen" idValue="defaultOpen" offValue="0" varName="defaultOpen" onValue="1"  idName="defaultOpen"  offLabel="{$jsp.portal.console.column.personalize.no#}" onLabel="{$jsp.portal.console.column.personalize.yes#}"   isSave="false" />									
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.column.defaultmove#}"/></html:td>
					<html:td >
						<com:switchbox boxId="defaultMove" varValue="columnViewBean.defaultMove" idValue="defaultMove" offValue="0" varName="defaultMove" onValue="1"  idName="defaultMove"  offLabel="{$jsp.portal.console.column.personalize.no#}" onLabel="{$jsp.portal.console.column.personalize.yes#}"   isSave="false" /> 														
					</html:td>
				</html:tr>
				<html:tr>
			...
			<html:table  cellSpacing="0"  align="center" isHead="false" >
				<html:tr ><html:td >
					<cext:priv code="_subsystem_column_manage_modify_save">
						<btn:save href="javascript:__vsubmit('columnForm')"/>
					</cext:priv>
					<cext:priv code="_subsystem_column_manage_modify_return">
