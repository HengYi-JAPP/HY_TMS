...
<html:form id="channelForm" name="channelForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="doAddRoleForSubSystemChannel"/>
			<html:hidden id="sysId" name="sysId" value="sysId"/>
			

			<jsp:include page="../../../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.portal.console.subconsole.column.assign.title") %>' name="title"/>		
			</jsp:include>
...
<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
				...
				<html:tr>
					...
					<com:lorbox lorBoxName="lorbox" filtDuplicated="true">
						...
						<com:rightbox itemId="roleId" list="roleOfChannel" itemValue="roleId" itemLabel="roleName" boxId="selectedRole"  orader="false"  boxLabel="{$jsp.privilege.group.assignrole.selected.role#}"/>
					</com:lorbox>	
