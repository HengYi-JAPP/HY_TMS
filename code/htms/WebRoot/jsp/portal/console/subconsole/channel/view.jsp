...
<com:loader css="css/common/table-list.css"  switchbox="true"/>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
				<html:tr>
					...
					<html:td >						
						<html:text name="channelCode" id="channelCode" styleClass="input-text" size="36"  value=""/>								
					</html:td>					
				...
				<html:tr>
					...
					<html:td >		
							<html:img src="channelViewBean.beforeIcon"></html:img>								
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.icon.after#}"/></html:td>
					<html:td >
						<html:img src="channelViewBean.afterIcon"></html:img>													
					</html:td>
				</html:tr>
				<html:tr>
			...
			<html:table  cellSpacing="0"  align="center" isHead="false" >
				<html:tr ><html:td >
					<cext:priv code="_subsystem_channel_manage_view_return">						
