...
<html:form id="channelForm" name="channelForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifySubSystemChannel"/>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
				<html:tr>
					...
					<html:td >						
						<html:text name="channelCode" id="channelCode" styleClass="input-text" value="channelViewBean.channelCode"/>								
					</html:td>			
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.channel.name#}"/></html:td>
					<html:td >
							<html:text name="channelName" id="channelName" styleClass="input-text" value="channelViewBean.channelName"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.icon.before#}"/></html:td>
					<html:td >	
						<com:simpleUpload fileId="beforeIcon" sortDir="themes/icons/system_$[sysId]" isImage="true" viewPath="channelViewBean.beforeIcon"></com:simpleUpload>								
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.icon.after#}"/></html:td>
					<html:td >
						<com:simpleUpload fileId="afterIcon" sortDir="themes/icons/system_$[sysId]" isImage="true" viewPath="channelViewBean.afterIcon"></com:simpleUpload>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.channel.url#}"/></html:td>
					<html:td >						
						<html:text name="channelUrl" id="channelUrl" styleClass="input-text" value="channelViewBean.channelUrl"/>									
					</html:td>				
			...
			<html:table  cellSpacing="0"  align="center" isHead="false" >
				<html:tr ><html:td >
						<cext:priv code="_subsystem_channel_manage_modify_save">
							<btn:save href="javascript:__vsubmit('channelForm')"/>
						</cext:priv>
						<cext:priv code="_subsystem_channel_manage_modify_return">
		...
		<com:validator formId="channelForm" showNormal="true" submitValidate="true" >	
			...
			<com:vElement id="showHeight"  types="none" event="onblur">
				<com:init size="8" maxlength="5" ></com:init>
			</com:vElement>
