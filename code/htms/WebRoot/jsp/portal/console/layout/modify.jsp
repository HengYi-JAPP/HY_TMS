...
<html:form id="layoutForm" name="layoutForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifyLayout"/>
			<html:hidden id="checkChannelId" name="checkChannelId" value="layoutViewBean.channelId"/>
			<html:hidden name="layoutId" id="layoutId"  value="layoutViewBean.layoutId"/>
		<html:hidden id="sysId" name="sysId" value="sysId"/>
			<jsp:include page="../../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.portal.console.layout.modify.title") %>' name='title'/>		
			</jsp:include>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">
				<html:tr>
					...
					<html:td >
							<html:text name="layoutName" id="layoutName" styleClass="input-text" value="layoutViewBean.layoutName"/>													
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.layout.tmplpath#}"/></html:td>
					<html:td >
						<html:text name="layoutTempl" id="layoutTempl" styleClass="input-text" value="layoutViewBean.layoutTempl"/> 														
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.layout.deficonpath#}"/></html:td>
					<html:td >	
						<com:simpleUpload fileId="layoutLogo" sortDir="system_$[sysId]/layout/icons/" isImage="true" viewPath="$[layoutViewBean.layoutLogo]"></com:simpleUpload>								
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.layout.seliconpath#}"/></html:td>
					<html:td>
						<com:simpleUpload fileId="layoutSelectedLogo" sortDir="system_$[sysId]/layout/icons/" isImage="true" viewPath="$[layoutViewBean.layoutSelectedLogo]"></com:simpleUpload>														
					</html:td>
				</html:tr>
				...
				<html:tr>
					...
					<html:td >						
						<com:switchbox boxId="isValidate" varValue="layoutViewBean.isValidate" idValue="isValidate" offValue="0" varName="isValidate" onValue="1"  idName="isValidate"  offLabel="{$jsp.common.status.validate.invalidate#}" onLabel="{$jsp.common.status.validate.validate#}"  isSave="false" />									
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.layout.order#}"/></html:td>
					<html:td >
						<html:text name="defaultOrder" id="defaultOrder" styleClass="input-text" value="layoutViewBean.defaultOrder"/> 														
					</html:td>
				</html:tr>
				...
				<html:tr>
					...
					<html:td >						
						<com:switchbox boxId="defaultShow"  varValue="layoutViewBean.defaultShow" idValue="defaultShow" offValue="0" varName="defaultShow" onValue="1"  idName="defaultShow"  offLabel="{$jsp.portal.console.layout.isshow.no#}" onLabel="{$jsp.portal.console.layout.isshow.yes#}"  isSave="false"  />									
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.layout.defselect#}"/></html:td>
					<html:td >
						<com:switchbox boxId="defaultSelect"  varValue="layoutViewBean.defaultSelect" idValue="defaultSelect" offValue="0" varName="defaultSelect" onValue="1"  idName="defaultSelect" offLabel="{$jsp.portal.console.layout.defselect.no#}" onLabel="{$jsp.portal.console.layout.defselect.yes#}"   isSave="false" />																		
					</html:td>
				</html:tr>
				...
				<html:tr>
					...
					<html:td colspan="3">
							<html:textarea name="layoutDesc" id="layoutDesc" styleClass="input-text" cols="40" rows="8" value="layoutViewBean.layoutDesc"></html:textarea>				
					</html:td>
				</html:tr>
