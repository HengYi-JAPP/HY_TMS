...
<html>
	...
	<html:form id="paramsForm" name="paramsForm" method="post" action="contoller.do">
		<html:hidden id="operation" name="operation" value="addThemesParamsValueByTypeId"/>
		...
		<html:table styleClass="dgbackground" cellSpacing="0"  border="1" id="userGrid_DataGrid1" style="width: 100%;; border-collapse: collapse;" align="center" list="defineParamsValueList" bean="paramsBean" isHead="true" >
			<html:tr styleClass="dgAlternatingItemStyle" headerStyleClass="dgHeaderStyle" onmouseover="onMouseMoveOverTableList(this)">
				<html:td  label="{$jsp.portal.themes.defvar.define.param.var#}"  property="paramsName"  />
				<html:td  label="{$jsp.portal.themes.defvar.define.param.code#}"  property="paramsCode"  />
				
				<html:td label="{$jsp.portal.themes.defvar.define.param.value#}" >
					<logic:if equal="paramsBean.paramsType,texttype">
					...
					<logic:if equal="paramsBean.paramsType,imagetype">
						<html:hidden name="valueContent" id="$[paramsBean.valueId]" value="paramsBean.valueContent" />
						<com:simpleUpload fileId="$[paramsBean.valueId]" sortDir="themes/global/vars" viewPath="paramsBean.valueContent" isImage="true"></com:simpleUpload>
					</logic:if>
					
					<logic:if equal="paramsBean.paramsType,colortype">
					...
					<logic:if equal="paramsBean.paramsType,fonttype">
						<html:text name="valueContent" id="valueContent" value="paramsBean.valueContent" maxlength="30" styleClass="input_text" defaultValue=" "/>
					</logic:if>
