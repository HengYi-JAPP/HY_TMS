...
<html:form id="itemForm" name="itemForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifyCssItem"/>
			<html:hidden id="itemId" name="itemId" value="itemViewBean.itemId"/>
		...
		<html:hidden id="ownderType" name="ownderType" value="ownderType"/>
			...
			<jsp:include page="../../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.portal.themes.cssitem.modify.title") %>' name='title'/>	
			</jsp:include>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">	
				...
				<html:tr>
					...
					<html:td >
							<html:text name="itemCode" id="itemCode" styleClass="input-text" value="itemViewBean.itemCode"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.themes.cssitem.value#}"/></html:td>
					<html:td >
							<html:text name="itemValue" id="itemValue" styleClass="input-text" value="itemViewBean.itemValue"/>													
					</html:td>							
				</html:tr>
				...
				<html:tr>
					...
					<html:td >						
						<com:switchbox boxId="isValidate" varValue="itemViewBean.isValidate" idValue="isValidate" offValue="0" varName="isValidate" onValue="1"  idName="isValidate"  offLabel="{$jsp.common.status.validate.invalidate#}" onLabel="{$jsp.common.status.validate.validate#}"   isSave="false" />									
					</html:td>	
				</html:tr>
