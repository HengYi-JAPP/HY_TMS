...
<html:form id="cssForm" name="cssForm" method="post" action="contoller.do">
		...
		<html:hidden id="ownderType" name="ownderType" value="ownderType"/>
			...
			<jsp:include page="../../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.portal.themes.css.modify.title") %>' name='title'/>	
			</jsp:include>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">	
				...
				<html:tr>
					...
					<html:td >
							<html:text name="cssCode" id="cssCode" styleClass="input-text" value="cssViewBean.cssCode"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.themes.css.name#}"/></html:td>
					<html:td >
							<html:text name="cssName" id="cssName" styleClass="input-text" value="cssViewBean.cssName"/>													
					</html:td>							
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.themes.css.order#}"/></html:td>
					<html:td >
							<html:text name="showOrder" id="showOrder" styleClass="input-text" value="cssViewBean.showOrder"/>													
					</html:td>							
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.themes.css.content#}"/></html:td>
					<html:td >
							<html:textarea name="cssContent" id="cssContent" styleClass="input-text" cols="40" rows="8" value="cssViewBean.cssContent"></html:textarea>	
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.themes.css.desc#}"/></html:td>
					<html:td >
							<html:textarea name="cssDesc" id="cssDesc" styleClass="input-text" cols="40" rows="8" value="cssViewBean.cssDesc"></html:textarea>	
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.status.validate#}"/></html:td>
					<html:td >						
						<com:switchbox boxId="isValidate" varValue="cssViewBean.isValidate" idValue="isValidate" offValue="0" varName="isValidate" onValue="1"  idName="isValidate"  offLabel="{$jsp.common.status.validate.invalidate#}" onLabel="{$jsp.common.status.validate.validate#}"   isSave="false" />									
					</html:td>	
				</html:tr>
			...
			<html:table  cellSpacing="0"  align="center" isHead="false" >
				<html:tr ><html:td >
						...
						<btn:return href="contoller.do?operation=listCss&ownerId=$[cssViewBean.ownerId]&ownderType=$[ownderType]&themesId=$[themesId]"/>								
				</html:td></html:tr>
			</html:table>	
