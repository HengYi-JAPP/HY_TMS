...
<html:form id="bgdForm" name="bgdForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifyBackground"/>
			<html:hidden id="bgdId" name="bgdId" value="bgdViewBean.bgdId"/>
			<jsp:include page="../../../common/impart/table-banner.jsp">
				<jsp:param value='<%=tools.tool.getLocal("jsp.portal.themes.background.modify.title") %>' name='title'/>		
			</jsp:include>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">	
				<html:tr>
					...
					<html:td >
							<html:radio name="bgdType" id="bgdType"  value="1" checked="bgdViewBean.bgdType" onclick="changeBgdType(this.value);" /><html:label label="{$jsp.portal.themes.background.image#}"/> <html:radio name="bgdType" id="bgdType"  checked="bgdViewBean.bgdType"   value="2"  onclick="changeBgdType(this.value);"/>  <html:label label="{$jsp.portal.themes.background.color#}"/>	
					</html:td>
				</html:tr>
				...
				<html:tr>
					...
					<html:td >
							<html:text name="bgdCode" id="bgdCode" styleClass="input-text" size="36" maxlength="60"  value="bgdViewBean.bgdCode"/>													
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.themes.background.name#}"/></html:td>
					<html:td >
							<html:text name="bgdName" id="bgdName" styleClass="input-text" size="36" maxlength="60"  value="bgdViewBean.bgdName"/>													
					</html:td>							
				</html:tr>
				<html:tr>	
					<html:td align="right" styleClass="edit-content-label"><html:label label="{$jsp.portal.themes.background.icon#}"/></html:td>
					<html:td>					
						<html:hidden name="bgdIcon" id="bgdIcon"  value="bgdViewBean.bgdIcon"/>
						<html:div id="bgdIconImageDiv" >
							<com:simpleUpload fileId="bgdIcon"  isImage="true" viewPath="bgdViewBean.bgdIcon"></com:simpleUpload>
						</html:div>
						<html:text name="bgdIconColor" id="bgdIconColor"  size="12" value="bgdViewBean.bgdIcon" style="display:none" onclick="coloropen(this.id,'bgdIcon');" onblur="document.getElementById('bgdIcon').value=this.value;"/>
					</html:td>
				</html:tr>
				<html:tr>	
					<html:td align="right" styleClass="edit-content-label"><html:label label="{$jsp.portal.themes.background.background#}"/></html:td>
					<html:td>					
						<html:hidden name="bgdContent" id="bgdContent"  value="bgdViewBean.bgdContent"/>
						<html:div id="bgdContentImageDiv" >
							<com:simpleUpload fileId="bgdContent"  isImage="true"  viewPath="bgdViewBean.bgdContent"></com:simpleUpload>
						</html:div>
						<html:text name="bgdContentColor" id="bgdContentColor"  size="12" value="bgdViewBean.bgdContent" style="display:none" onclick="coloropen(this.id,'bgdContent');" onblur="document.getElementById('bgdContent').value=this.value;"/>
					</html:td>
				</html:tr>	
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.themes.background.desc#}"/></html:td>
					<html:td >
							<html:textarea name="bgdDesc" id="bgdDesc" styleClass="input-text" cols="40" rows="8" value="bgdViewBean.bgdDesc"></html:textarea>	
					</html:td>
				</html:tr>
...
<script type="text/javascript">
<!--
changeBgdType('<html:value value="bgdViewBean.bgdType"/>');
//-->
</script>
