...
<html:form id="channelForm" name="channelForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="modifyUserSelfChannel"/>
			<html:hidden   name="sysId" value="$[sysId]" />
			<html:hidden   name="currentSysCode" value="$[currentSysCode]" />
			<html:hidden id="channelId" name="channelId" value="userChannelBean.channelId"/>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">				
				<html:tr>
					...
					<html:td >
							<html:text name="channelName" id="channelName" styleClass="input-text" value="userChannelBean.channelName"/>													
					</html:td>
				...
				<html:tr>
					...
					<html:td >	
						<com:simpleUpload fileId="beforeIcon" sortDir="personalfiles/system_$[sysId]/$[userId]/icons" isImage="true" viewPath="userChannelBean.beforeIcon"></com:simpleUpload>								
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.icon.after#}"/></html:td>
					<html:td >
						<com:simpleUpload fileId="afterIcon" sortDir="personalfiles/system_$[sysId]/$[userId]/icons" isImage="true" viewPath="userChannelBean.afterIcon"></com:simpleUpload>													
					</html:td>
				</html:tr>
				...
				<html:tr>
					...
					<html:td >						
						<html:text name="channelUrl" id="channelUrl" styleClass="input-text" value="userChannelBean.channelUrl"/>									
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.channel.load#}"/></html:td>
					<html:td >
						<com:switchbox boxId="loadStyle"  varValue="userChannelBean.loadStyle" idValue="loadStyle" offValue="0" varName="loadStyle" onValue="1"  idName="loadStyle"  offLabel="{$jsp.portal.console.channel.load.async#}" onLabel="{$jsp.portal.console.channel.load.sync#}"  isSave="false"/>													
					</html:td>
				</html:tr>
				...
				<html:tr>
					...
					<html:td >						
						<com:switchbox boxId="defaultShow"  varValue="userChannelBean.defaultShow" idValue="defaultShow" offValue="0" varName="defaultShow" onValue="1"  idName="defaultShow"  offLabel="{$jsp.portal.console.channel.isshow.no#}" onLabel="{$jsp.portal.console.channel.isshow.yes#}"  isSave="false"  />									
					</html:td>				
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.channel.defselect#}"/></html:td>
					<html:td >
						<com:switchbox boxId="defaultSelect"  varValue="userChannelBean.defaultSelect" idValue="defaultSelect" offValue="0" varName="defaultSelect" onValue="1"  idName="defaultSelect"  offLabel="{$jsp.portal.console.channel.defselect.no#}" onLabel="{$jsp.portal.console.channel.defselect.yes#}"   isSave="false" />																		
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.common.operation.composite.showheight#}"/></html:td>
					<html:td >	
						<html:text name="showHeight" id="showHeight" styleClass="input-text" value="userChannelBean.showHeight" /> 											
					</html:td>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.console.channel.order#}"/></html:td>
					<html:td >
						<html:text name="defaultOrder" id="defaultOrder" styleClass="input-text" value="userChannelBean.defaultOrder" /> 														
					</html:td>
				</html:tr>
			</html:table>
