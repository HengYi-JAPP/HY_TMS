...
<html:form id="layoutForm" name="layoutForm" method="post" action="contoller.do">
			<html:hidden id="operation" name="operation" value="saveUserDefineLayout"/>
			...
			<html:hidden name="defaultShow" id="defaultShow" value="1"/>
			<html:hidden name="defaultSelect" id="defaultSelect" value="0"/>
			<html:hidden name="defaultOrder" id="defaultOrder" value="10000"/>
			...
			<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">
				<html:tr>
					...
					<html:td >	
						<html:text name="layoutName" id="layoutName" styleClass="input-text" size="36" maxlength="60" value=""/>
						<html:hidden id="layoutDesc" name="layoutDesc" value="{$jsp.portal.website.personalize.layout.selfdefine#}" />  											
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.website.personalize.layout.defaulticon#}" /></html:td>
					<html:td >								
							<com:simpleUpload fileId="layoutLogo" isImage="true"></com:simpleUpload>														
					</html:td>
				</html:tr>
				<html:tr>
					<html:td styleClass="edit-talbe-label"><html:label label="{$jsp.portal.website.personalize.layout.selectedicon#}" /></html:td>
					<html:td >
					<com:simpleUpload fileId="layoutSelectedLogo" isImage="true"></com:simpleUpload>														
					</html:td>
				</html:tr>
			</html:table>
