...
<html:table  styleClass="edit-talbe" align="center" cellPadding="0" cellSpacing="0">	
				...
				<html:tr>
					...
					<html:td >						
						<com:tree treeList="compositeList" checkedTreeList="checkedCompositeList" treeName="myTree" chooseStyle="single"  useNodeImage="true" expandAll="1" cacheElementName="parentId" >
			...
			<html:table  cellSpacing="0"  align="center" isHead="false" >
				<html:tr ><html:td >					
						<btn:return href="contoller.do?operation=listUserChannelComposite&currentSysCode=$[currentSysCode]&sysId=$[sysId]&channelId=$[channelId]"/>							
				</html:td></html:tr>
			</html:table>	
