...
String sysCode= (String)requestHelper.getValueFromAllScopes("sysCode");
String isConsole=request.getParameter("isConsole");
isConsole=isConsole==null||"".equals(isConsole.trim())?"false":isConsole;
String loginOperation = "LoginAction_of_myportal";
if("true".equalsIgnoreCase(isConsole)){
	loginOperation = "LoginAction_of_commonSystem";
}
%>
<html>
...
<style>
	#loginbtn{ width:316px; background:url(<%=basePath%>jsp/wsites/<%=sysCode%>/images/btn.png)  0 0 no-repeat;height:44px;line-height: 31px;text-align: center; border:none; outline:none; font-size:16px; height:44px;  color:#fff; letter-spacing:5px; cursor:pointer; border-radius:5px;position: absolute;left: 50%;margin-left: -158px;top: 20px;font-weight: bold;}
	#loginbtn:hover{ background:url(<%=basePath%>jsp/wsites/<%=sysCode%>/images/btn.png) 0 0 no-repeat;}
...
<html:hidden id="operation" name="operation" value="<%=loginOperation %>" />
	<html:div styleClass="topcon">
		<html:div styleClass="top topbg">
			...
			<html:div styleClass="tlogo">
				<a href="javascript:void(0);" class="logo"><b></b><p class="text">EthERNet</p><p class="text2">Edu Research</p></a>
			</html:div>
		</html:div>
	</html:div>
	...
	<html:div styleClass="main">
		<html:div styleClass="con_banner">
			<html:div id="tips_banner" styleClass="viewport">
				<ul class="sliders cb">
					<li> <a href="#"><html:img src="jsp/wsites/$[sysCode]/images/l_bg.png" /></a></li>
					<li> <a href="#"><html:img src="jsp/wsites/$[sysCode]/images/l_bg.png" /></a></li>
					<li> <a href="#"><html:img src="jsp/wsites/$[sysCode]/images/l_bg.png" /></a></li>
					<li> <a href="#"><html:img src="jsp/wsites/$[sysCode]/images/l_bg.png" /></a></li>
				</ul>
		...
		<html:div styleClass="l_box">
			<html:div styleClass="inputbox">
				...
				<html:div styleClass="logInfo mb20">
					...
					<html:text name="account" id="account" styleClass="log_input"   value="ethnet"/>
				</html:div>
				
				<html:div styleClass="logInfo mb20">
					<html:div styleClass="inputCon" ><html:span styleClass="l_icon2"></html:span> </html:div>
					<html:password name="pwd" id="pwd" styleClass="log_input" value="1234" onkeydown="keydown('13','submit','loginForm');"/>
				</html:div>
				...
				<html:div styleClass="logInfo ">
					<html:div styleClass="inputCon">
						<html:checkbox/> Next Auto Login <html:a href="https://www.baidu.com/" styleClass="fr">Forget the password?</html:a>
					</html:div>
				</html:div>
				
				<html:div styleClass="logInfo ">
					<html:div styleClass="inputCon" >
						<input type="submit" id="loginbtn" value="Sign in" onclick="submit('loginForm')"/>
					</html:div>
				</html:div>
