...
public class TransportUtils {
	...
	public static int getMaterialSize(Map<String,Map<String, List<TransportBean>>> orderMap){
		List<TransportBean> transportLists =null;
	...
	public static int getOrderSize(Map<String, List<TransportBean>> applyMap){
		List<TransportBean> transportLists =null;
		Set applySet=null;
