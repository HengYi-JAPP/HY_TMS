...
priceunit=24,pricetype=6,freightmodel=1 ,validatedate ='2017-12-25'
Where str5='按单价';
...
priceunit=24,pricetype=6,freightmodel=2 ,validatedate ='2017-12-25'
Where str5='一口价';
...
Update tb_htms_transprice_dty  d Set  d.areacode2 = (Select areacode From tb_htms_area a Where   a.areaname=d.str2 And areacode Like d.areacode1||'%')，
 ...
 Update tb_htms_transprice_dty  d Set  d.areacode2 = (Select areacode From tb_htms_area a Where    '南通'||a.areaname like d.str2||'市' And areacode Like d.areacode1||'%')，
                                      d.areacname2 = (Select areaname From tb_htms_area a Where    '南通'||a.areaname like d.str2||'市' And areacode Like d.areacode1||'%')，
                                      d.areaid2 = (Select areaid From tb_htms_area a Where   '南通'|| a.areaname like d.str2||'市' And areacode Like d.areacode1||'%')
                                      where d.areaid2 is null  And str2 Is not Null ;
...
upate tb_htms_transprice_dty  set backstr = routeid ;
...
and r.factoryid =d.factoryid  and r.productid =d.productid  and  routeid not in (3312,3318,3023,3026)
 ) ;
...
update tb_htms_transprice_dty  set routeid  = backstr  where routeid is null ; 



Insert Into tb_htms_route (routeid ,productid ,factoryid ,areaid ,isvalidate)
Select  Distinct routeid ,productid ,factoryid ,areaid ,isvalidate  From tb_htms_transprice_dty Where routeid > 5149 
